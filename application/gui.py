...
cv2.putText(interface,'c',(sysWidth-400,sysHeight-11),cv2.FONT_HERSHEY_SIMPLEX,0.47,(255,255,255),1)
cv2.putText(interface,'  DEEPANK PURI(deepankpuri@gmail.com)',(sysWidth-400,sysHeight-10),cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),1)
...
def screen():
	global interface
	cv2.namedWindow('DEEPANK_PURI__IMAGE_ENHANCEMENT_SOFTWARE__(deepankpuri@gmail.com)',cv2.WINDOW_NORMAL)
	cv2.resizeWindow('DEEPANK_PURI__IMAGE_ENHANCEMENT_SOFTWARE__(deepankpuri@gmail.com)',sysWidth,sysHeight)
	showScreen()

def showScreen():
	cv2.imshow('DEEPANK_PURI__IMAGE_ENHANCEMENT_SOFTWARE__(deepankpuri@gmail.com)',interface)
...
# cv2.imshow('Menu',menu[currentMenu][0])
screenMenu()
cv2.setMouseCallback('DEEPANK_PURI__IMAGE_ENHANCEMENT_SOFTWARE__(deepankpuri@gmail.com)',functionerMenu)
